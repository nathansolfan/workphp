...
<!-- <?php inspect($users) ?> -->
    ...
    <section>
     ...
     <!-- do the foreach and $listing for the single item and close foreach at bottom -->
          <?php foreach($listings as $listing) : ?>
          
          <div class="rounded-lg shadow-md bg-white">
            <div class="p-4">
              <!-- dinamically display title with , can be changed <?= $listing->title ?>-->
